...
TEMP_MIN = 0. #What is the lowest temperature on a scale
TEMP_MAX = 150. #What is the highest temperature on a scale
DANGER_TEMP = 75. #What temperature should be considered dangerous
